...
DEST="/home/fernando/dev/blacklist/whitelists/google_user_triggered_fetchers_ipv4.txt"
TMP_FILE=$(mktemp)

# Baixar e filtrar os prefixos IPv4
if curl -sS 'https://developers.google.com/search/apis/ipranges/user-triggered-fetchers.json' \
